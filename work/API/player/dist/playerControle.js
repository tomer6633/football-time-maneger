...
exports.addPlayer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userName, position, playerDB, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, userName = _a.userName, position = _a.position;
                console.log(userName, position);
                return [4 /*yield*/, playerModel_1["default"].create({ userName: userName, position: position })];
            case 1:
                playerDB = _b.sent();
